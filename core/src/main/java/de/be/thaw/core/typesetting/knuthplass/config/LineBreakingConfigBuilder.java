package de.be.thaw.core.typesetting.knuthplass.config;

import de.be.thaw.core.typesetting.knuthplass.config.util.FontDetailsSupplier;
import de.be.thaw.core.typesetting.knuthplass.config.util.GlueConfig;
import de.be.thaw.core.typesetting.knuthplass.config.util.hyphen.Hyphenator;
...
public class LineBreakingConfigBuilder {
    ...
    /**
     * Default size of the page to typeset on (in millimeters).
     */
    ...
    /**
     * Set the page size of the page to typeset on (in mm).
     *
